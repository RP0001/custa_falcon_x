"""
Django settings for custa_falcon_x project.
...
SECRET_KEY = '@+oaj3-t2fjq^bio#pm*(6a^5ol#!s3x5g9o#ff2eb1+0f_tw3'
...
ROOT_URLCONF = 'custa_falcon_x.urls'
...
WSGI_APPLICATION = 'custa_falcon_x.wsgi.application'
